...
const meta = {
  ...
  argTypes: {
    variant: { control: "inline-radio", options: ["neutral", "accent", "outline", "domain"] },
...
export const Accent: Story = { args: { variant: "accent", children: "Show HN" } };

export const Outline: Story = { args: { variant: "outline", children: "Job" } };

export const WithIcon: Story = { args: { icon: ChartColumn, children: "Poll" } };

export const Domain: Story = { args: { variant: "domain", href: "/", children: "wsj.com" } };
